-- Load a different tilemap image relevant to current system time
local current_system_hour = os.date("*t").hour
local map_texture_asset_id

-- From 9am - 6am, show day map, else night map
        ...
        [0] =
            ...
            components = {
                label = {
                    position = { x = 582, y = 10 },
                    text = "CHOPPER GAME",
                    texture_asset_id = "charriot-font-20",
                    fixed = true
                },
            }
        },
        ...
        -- Controls Text
            components = {
                label = {
                    ...
                    text = "WASD: Move | Space: Shoot | M: Music | 9: Dev Mode | ESC: To Exit",
                    texture_asset_id = "charriot-font-20",
                    fixed = true
                },
            }
            ...
            components = {
                ...
                on_update_script = {
                    ...
                    function(entity, delta_time, ellapsed_time)
                        ...
                        local current_position_x, current_position_y = get_position(entity) -- returning a tuple
                        local current_velocity_x, current_velocity_y = get_velocity(entity) -- returning a tuple
            ...
            components = {
                ...
                on_update_script = {
                    ...
                    function(entity, delta_time, ellapsed_time)
                        ...
                        -- change the position of the the jet to follow a sine wave movement
                        local new_x = ellapsed_time * 0.09 -- reduce variable
                        local new_y = 200 + (math.sin(ellapsed_time * 0.001) * 50) -- y pos moves on sine wave
